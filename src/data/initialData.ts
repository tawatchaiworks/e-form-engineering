import { StaffMember, EEngineerRequest, EngineerInquiry, EngineerDailyAttendance, FaqItem } from '../types';
...
export const INITIAL_FAQS: FaqItem[] = [
  {
    ...
    categoryLabel: 'การเลือกหม้อแปลง Switching 24V',
    question: 'หลักการคำนวณและเลือกขนาดวัตต์ (Watt) ของหม้อแปลง Switching 24VDC ให้เสถียรและปลอดภัยตลอดอายุการใช้งาน?',
    summary: 'ต้องคำนวณกำลังไฟฟ้ารวมของโหลดไฟ LED (Total Wattage) ทั้งหมด แล้วเผื่อค่า Safety Factor (Safety Margin) ไว้อย่างน้อย 20% - 30% (หรือใช้งานไม่เกิน 70% - 80% ของพิกัดหม้อแปลง) เพื่อป้องกันปัญหาหม้อแปลงร้อนเกิน Overload และ Overheating Protection ตัดการทำงาน',
    steps: [
      '1. รวมกำลังวัตต์ทั้งหมด: หาความยาวไฟ LED Strip (เมตร) × กำลังวัตต์ต่อเมตร (W/m) = วัตต์รวมทั้งหมด (P_total)',
      '2. คำนวณ Safety Factor (20% - 30%): วัตต์หม้อแปลงขั้นต่ำ = P_total ÷ 0.80 (หรือ P_total × 1.25)',
      '3. ตรวจสอบกระแสรวม (Ampere): คำนวณ I = P_total ÷ 24V เพื่อเตรียมขนาดสายไฟและเบรกเกอร์',
      '4. เลือกเกรดมาตรฐาน: เลือกหม้อแปลงแบรนด์มาตรฐาน (เช่น Mean Well LPV/XLG หรือเกรดอุตสาหกรรม) ที่มีระบบป้องกัน SCP, OVP, OLP สมบูรณ์แบบ'
    ],
    technicalTips: 'หากใช้งานไฟเปิดต่อเนื่องเกิน 8 ชั่วโมงต่อวัน แนะนำเผื่อ Safety Margin ที่ 30% เสมอ และควรวางหม้อแปลงในพื้นที่ระบายความร้อนได้ดี หลีกเลี่ยงการวางซ้อนกันในฝ้าปิดทึบ',
    commonCauses: [
      'ไฟกระพริบเป็นจังหวะ เกิดจากหม้อแปลงวัตต์ไม่พอ จนเข้าสู่โหมด Hiccup Overload Protection',
      'หม้อแปลงตัดดับหลังเปิดไป 15-30 นาที เกิดจากความร้อนสะสมระบายไม่ออก Thermal Cutoff ทำงาน'
    ],
    specsTable: [
      { label: 'โหลดรวม 60W', value: 'เลือกหม้อแปลง 24V อย่างน้อย 75W - 100W' },
      { label: 'โหลดรวม 120W', value: 'เลือกหม้อแปลง 24V อย่างน้อย 150W - 200W' },
      { label: 'โหลดรวม 240W', value: 'เลือกหม้อแปลง 24V อย่างน้อย 300W - 350W' }
    ],
    tags: ['หม้อแปลง 24V', 'Switching', 'Safety Factor', 'MeanWell', 'Overload Protection'],
    authorName: 'ช่างพัด (Lighting Control Engineer)',
  ...
  },
  {
    ...
    categoryLabel: 'การเลือกหม้อแปลงดิม (Dimmable Drivers)',
    question: 'เปรียบเทียบระบบหรี่แสงไฟ 24V: TRIAC vs 0-10V/1-10V vs DALI vs DMX ควรเลือกใช้อย่างไรให้เหมาะสมกับงานโครงการ?',
    summary: 'แต่ละโปรโตคอลมีลักษณะสัญญาณและการเดินสายที่ต่างกัน: TRIAC เหมาะกับงานเปลี่ยนแทนสวิตช์ดิมเดิมโดยไม่ต้องเดินสายเพิ่ม, 0-10V เหมาะกับระยะสั้น-ปานกลางสายสัญญาณแอนะล็อก 2 คอร์, DALI-2 เหมาะกับงานสั่งการเป็นแอดเดรสและกลุ่มแบบดิจิทัลความแม่นยำสูง, DMX512 เหมาะกับงานแสงสี RGBW ที่ต้องการ Dynamic Speed สูง',
    steps: [
      '1. TRIAC / Phase Cut: หรี่ที่ฝั่งไฟเข้า AC 220V ไม่ต้องเดินสายสัญญาณคุม เหมาะกับงาน Renovate หรือบ้านพักอาศัยที่เดินสาย 2 สายไว้แล้ว',
      '2. 0-10V / 1-10V: เดินสายคุมสัญญาณแยก 2 เส้น (ขั้ว + และ -) ควบคุมเป็น Loop ทั้งชุด ไม่สามารถสั่งแยกแอดเดรสหลอดได้',
      '3. DALI / DALI-2: สัญญาณดิจิทัล 2 สาย (DA, DA) ไม่สลับขั้ว รองรับ 64 แอดเดรสต่อ 1 พอร์ต สามารถจัด Group และ Scene ได้อิสระผ่านซอฟต์แวร์',
      '4. DMX512: สัญญาณความเร็วสูง RS-485 ใช้สายชีลด์ 3 คอร์ เหมาะกับงานโคมสี RGBW/Pixel วิ่งตามจังหวะเพลงหรืองานสถาปัตยกรรมระดับสูง'
    ],
    technicalTips: 'ควรเลือกไดรเวอร์ดิมมิ่งประเภท Constant Voltage (CV) สำหรับ LED Strip และ Constant Current (CC) สำหรับ Downlight/Spotlight โดยต้องตรวจสอบค่า Minimum Dimming Level (1% หรือ 0.1% Deep Dimming แบบ Flicker-Free) เพื่อลดอาการกระพริบที่ความสว่างต่ำ',
    tags: ['Dimming', 'DALI-2', '0-10V', 'TRIAC', 'Phase Cut', 'DMX512', 'Flicker-Free'],
    authorName: 'ช่างโชค (Systems Engineer)',
  ...
  },
  {
    ...
    categoryLabel: 'การเลือกสายไฟ 24V และระยะสาย (Voltage Drop)',
    question: 'วิธีเลือกขนาดสายไฟ (Cross-section mm²) และระยะเดินสายไฟแรงดันต่ำ DC 24V เพื่อไม่ให้แรงดันตก (Voltage Drop) เกิน 3-5%?',
    summary: 'ไฟแรงดันต่ำ 24VDC มีกระแสไหลสูงกว่าระบบ 220VAC หลายเท่า ทำให้เกิดการสูญเสียแรงดันตกคร่อมสาย (Voltage Drop) ได้ง่าย หากสายไฟเล็กหรือระยะทางยาวเกินไป ปลายสายจะได้แรงดันต่ำกว่า 22V ส่งผลให้ไฟหรี่ แสงไม่สม่ำเสมอ หรือไดรเวอร์ตัดการทำงาน',
    steps: [
      '1. สูตรคำนวณแรงดันตก: V_drop = (2 × L × I × ρ) ÷ A (โดย L = ระยะทางขาเดียวเป็นเมตร, I = กระแสแอมป์, ρ = สภาพต้านทานทองแดง 0.0175, A = พื้นที่หน้าตัดสาย mm²)',
      '2. เกณฑ์มาตรฐาน: V_drop ต้องไม่เกิน 5% (คือตกไม่เกิน 1.2V ในระบบ 24V หรือแรงดันปลายทางเหลือไม่ต่ำกว่า 22.8V)',
      '3. เทคนิคจ่ายไฟสองหัว (Dual Injection / Loop Feed): สำหรับเส้นไฟ LED Strip ยาวเกิน 5 เมตร ให้ป้อนไฟหัว-ท้าย เพื่อเฉลี่ยแรงดันให้ทั่วทั้งเส้น',
      '4. แยกจุดหม้อแปลง: พยายามวางหม้อแปลงให้อยู่ใกล้ชุดโคมไฟมากที่สุดเท่าที่ทำได้ (ระยะทางที่ดีที่สุดไม่ควรเกิน 10-15 เมตร)'
    ],
    specsTable: [
      { label: 'ระยะ 1 - 5 เมตร (กระแส < 3A)', value: 'ใช้สาย VCT/THW 1.0 - 1.5 sq.mm' },
      { label: 'ระยะ 5 - 12 เมตร (กระแส 3A - 6A)', value: 'ใช้สาย VCT 2.5 sq.mm' },
      { label: 'ระยะ 12 - 25 เมตร (กระแส 6A - 10A)', value: 'ใช้สาย VCT 4.0 - 6.0 sq.mm หรือย้ายตำแหน่งหม้อแปลง' }
    ],
    technicalTips: 'ห้ามใช้สายโทรศัพท์หรือสาย LAN มาจ่ายไฟกำลัง 24V DC เด็ดขาดเพราะความต้านทานสูงมากและเสี่ยงเกิดความร้อนไหม้ละลาย',
    tags: ['Voltage Drop', 'สายไฟ 24V', 'Dual Injection', 'ระยะสาย', 'ขนาดสาย VCT'],
    authorName: 'ช่างวิน (Field Test Engineer)',
    createdAt: '2026-08-16 09:30',
    isCustom: false
  },
  {
    ...
    categoryLabel: 'การตัดต่อไฟ LED Strip & Neon Flex 24V',
    question: 'ขั้นตอนและข้อควรระวังในการตัด ต่อสาย และเข้าหัวกันน้ำสำหรับไฟ LED Strip และ Silicone Neon Flex 24V?',
    summary: 'ไฟ LED Strip และ Neon Flex จะมีจุดตัด (Cut Mark) ตามระยะพิทช์ที่กำหนด (เช่น ทุก 2.5 ซม. หรือ 5 ซม.) ต้องตัดด้วยคัตเตอร์คมตรงแนวกรรไกรเท่านั้น และการบัดกรีต้องใช้ความร้อนพอเหมาะเพื่อไม่ให้ลายวงจรทองแดง PCB เสียหาย พร้อมทั้งซีลหัวท้ายด้วยฝาปิดซิลิโคนและกาวเกรด Neutral RTV เพื่อกันชื้น',
    steps: [
      '1. การตัด: ตัดเฉพาะตรงสัญลักษณ์รูปกรรไกรหรือแนวเส้นประทองแดงเท่านั้น ห้ามตัดบริเวณชิปหรือตัวต้านทาน',
      '2. การบัดกรีเชื่อมสาย: ปอกสายไฟ 2-3 มม. ไล้ตะกั่วที่จุด Pad ทองแดงและปลายสายก่อน แล้วจึงแตะเชื่อมโดยใช้เวลาไม่เกิน 2-3 วินาทีต่อจุด',
      '3. การเข้าหัว Neon Flex: สวมท่อหด หรือชุด End Cap ซิลิโคน หยอดกาวซิลิโคนใสชนิด Neutral Cure (ไม่มีกรดอะซิติก) ให้เต็มกระเปาะ',
      '4. การทดสอบก่อนติดตั้ง: ทดสอบจ่ายไฟตรวจสอบแสงและขั้วไฟ (+ / -) ก่อนติดตั้งและยึดเข้ากับรางอะลูมิเนียมเสมอ'
    ],
    technicalTips: 'ห้ามดัดหักงอ Neon Flex รัศมีความโค้งเกินกว่า Minimum Bending Radius (มักไม่เกิน 30-50 มม. ขึ้นกับขนาด) และห้ามบิดตัวหมุน (Twisting) เพราะจะทำให้ลายวงจรภายในขาดใน',
    tags: ['LED Strip', 'Neon Flex', 'การตัดต่อ', 'End Cap', 'Bending Radius', 'บัดกรี'],
    authorName: 'ช่างวัฒน์ (Installation & Mockup Engineer)',
  ...
  },
  {
    id: 'faq-5',
    category: 'underwater',
    categoryLabel: 'การติดตั้งและต่อสายไฟโคมใต้น้ำ (IP68 Underwater)',
    question: 'มาตรฐานความปลอดภัยระดับสูงสุดในการต่อสายไฟและติดตั้งโคมไฟใต้น้ำในสระว่ายน้ำและน้ำพุ (Safety Extra-Low Voltage SELV)?',
    summary: 'ตามมาตรฐานสากล IEC 60368-2-18 ระบบไฟสระว่ายน้ำ Zone 0 ต้องใช้แรงดันไฟไม่เกิน 12V AC/DC หรือ 24V DC (SELV) เท่านั้น และการต่อสายไฟใต้น้ำต้องใช้กล่องต่อสายเรซิ่นหล่อปิดผนึก (Gel / Resin Cast Waterproof Junction Box) เกรด IP68 แท้ 100%',
    steps: [
      '1. ใช้หม้อแปลงแยกขดลวดนิรภัย (Safety Isolating Transformer) หรือ SELV Power Supply ติดตั้งอยู่นอกเขตสระ (Zone 2 ขึ้นไป ห่างอย่างน้อย 2.0-3.5 เมตร)',
      '2. ห้ามตัดต่อสายไฟภายในตัวโคมไฟใต้น้ำ ให้ใช้สายเคเบิลสำเร็จรูปยางสังเคราะห์กันน้ำ (H07RN-F Rubber Cable) ลากตรงเข้ากล่องพักสายเหนือระดับน้ำ',
      '3. หากจำเป็นต้องต่อสายในบ่อน้ำ ต้องใช้ Resin Joint หรือ เจลกันน้ำ Magic Gel หุ้มจุดต่อสายแบบ 100% พร้อมทดสอบความเป็นฉนวน (Insulation Resistance > 50 MΩ)',
      '4. ต้องติดตั้งอุปกรณ์ป้องกันไฟดูด RCD / ELCB ความไวสูง 10mA หรือ 30mA ตัดฝั่งไฟเข้า AC 220V เสมอ'
    ],
    technicalTips: 'ห้ามเปิดทดสอบโคมไฟใต้น้ำเกรดสแตนเลส 316 บนบกเกิน 1 นาทีโดยไม่มีน้ำหล่อเลี้ยง เพราะโคมออกแบบมาให้ใช้น้ำระบายความร้อน ชิป LED และเลนส์อาจไหม้หรือแตกร้าวจากความร้อนสูง',
    tags: ['โคมใต้น้ำ', 'IP68', 'SELV 24V', 'Resin Cast', 'สระว่ายน้ำ', 'H07RN-F', 'ความปลอดภัย'],
    authorName: 'ช่างพัด (Lighting Control Engineer)',
    createdAt: '2026-08-16 10:00',
    isCustom: false
  },
  {
    ...
    categoryLabel: 'การติดตั้งโคมไฟในสวนและภูมิสถาปัตย์ (Landscape Lighting)',
    question: 'ข้อจำกัดและเทคนิคการติดตั้งโคมไฟฝังดิน (Inground / Uplight) และโคมไฟสนามในงาน Landscape เพื่อป้องกันน้ำซึมและความชื้นสะสม?',
    summary: 'โคมฝังดินมักเสียหายจาก "ปรากฏการณ์กาลักน้ำและสุญญากาศจากความร้อน (Thermal Vacuum Suction)" เมื่อโคมร้อนแล้วดับลงจะดูดความชื้นในดินเข้าไปทางต่อสายและซีลยาง ดังนั้นต้องมีระบบชั้นระบายน้ำกรวดหินด้านล่าง และใช้เคเบิลแกลนด์กันน้ำ IP68 ร่วมกับท่อร้อยสายชนิด HDPE',
    steps: [
      '1. การขุดหลุมรองรับ: ขุดหลุมลึกกว่าตัวโคมอย่างน้อย 20-30 ซม. แล้วเทหินกรวด (Gravel Drainage Layer) ด้านใต้เพื่อระบายน้ำขัง ไม่ให้โคมแช่อยู่ในโคลน',
      '2. การเดินสายไฟ: ใช้ท่อร้อยสายไฟกันน้ำร้อยสายเคเบิล และต่อสายในกล่องพักสายกันน้ำ IP67/IP68 ที่ยกสูงพ้นแนวน้ำท่วมขัง',
      '3. การประกอบหน้ากระจก: ขันน็อตสแตนเลสแบบทแยงมุม (Cross-pattern torquing) ให้แรงกดสม่ำเสมอรอบขอบยางซิลิโคน เพื่อไม่ให้ซีลบิดเบี้ยว',
      '4. สารดูดความชื้น: ใส่ซองซิลิก้าเจล (Desiccant bag) ภายในตัวโคมก่อนปิดฝา เพื่อดูดซับความชื้นในอากาศไม่ให้เกิดหยดน้ำเกาะหน้าเลนส์'
    ],
    technicalTips: 'ในงานภูมิสถาปัตย์ ควรเลือกใช้ระบบแรงดันต่ำ 24VDC แทน 220VAC เพื่อความปลอดภัยของผู้คนและสัตว์เลี้ยงเมื่อมีสายไฟชำรุดหรือถูกจอบขุดตัดสาย',
    tags: ['โคมไฟในสวน', 'โคมฝังดิน', 'Inground Up-Light', 'Thermal Vacuum', 'Landscape', 'Gravel Drainage'],
    authorName: 'ช่างวิน (Field Test Engineer)',
  ...
  },
  {
    ...
    categoryLabel: 'การวิเคราะห์ปัญหาหน้างาน (Engineering Troubleshooting)',
    question: 'รวมปัญหาที่พบบ่อยหน้างาน: ไฟกระพริบ, ดิมแล้วฮัมเสียงดัง, สีไฟเพี้ยนปลายสาย และวิธีแก้ไขทางวิศวกรรม?',
    summary: 'ปัญหาทางแสงและไฟฟ้าส่วนใหญ่มีสาเหตุจาก Voltage Drop, การไม่ต่อสายกราวด์สัญญาณคุม, PWM Frequency ชนกัน, หรือโหลดเกินกำลังของหม้อแปลง สามารถวิเคราะห์แก้ไขได้ตามตารางแนวทางช่างเทคนิค',
    steps: [
      '1. อาการไฟริบหรี่หรือแสงสั่น: ตรวจสอบความเข้ากันได้ระหว่าง Dimmer และ Driver หรือตรวจดูว่ามีการต่อสาย Neutral หลวมหรือไม่',
      '2. อาการปลายสายไฟดรอปสีเพี้ยน: วัดโวลต์ที่ปลายสาย หากต่ำกว่า 22V ให้เพิ่มขนาดสายไฟ หรือต่อไฟแบบหัว-ท้าย (Double Feed)',
      '3. อาการหม้อแปลงมีเสียงจี่ (Buzzing Noise): เกิดจากวงจรเหนี่ยวนำขดลวดในหม้อแปลงเกรดต่ำทำงานร่วมกับ Phase-cut Dimmer แนะนำเปลี่ยนเป็นระบบ 0-10V หรือ DALI PWM เกรดพรีเมียม',
      '4. สัญญาณ DALI ตอบสนองช้าหรือไม่ตอบสนอง: ตรวจสอบแรงดัน DALI Bus Voltage (ต้องอยู่ระหว่าง 9.5V - 22.5V ปกติ ~16V) และความยาวสาย DALI ไม่ควรเกิน 300 เมตร'
    ],
    technicalTips: 'เมื่อตรวจเช็คปัญหาหน้างาน ให้ใช้ Digital Multimeter วัดแรงดันทั้งตอนไม่มีโหลด (No-load voltage) และตอนเปิดไฟเต็มที่ (Full-load voltage) เพื่อเปรียบเทียบค่าแรงดันตกคร่อมที่แท้จริง',
    tags: ['Troubleshooting', 'ไฟกระพริบ', 'เสียงจี่ Buzzing', 'DALI Bus Voltage', 'ตรวจเช็คหน้างาน'],
    authorName: 'ช่างวัฒน์ (Installation & Mockup Engineer)',
