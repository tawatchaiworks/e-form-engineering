...
export const INITIAL_FAQS: FaqItem[] = [
  ...
  // 8. การคำนวณจุดคุ้มทุน & คืนทุนหลอดไฟ LED (Payback Period & Energy Saving ROI)
  {
    id: 'faq-payback-1',
    category: 'general',
    categoryLabel: 'ความรู้เทคนิคไฟฟ้าทั่วไป',
    question: 'สูตรการคำนวณจุดคุ้มทุน (Payback Period) และผลตอบแทน (ROI) เมื่อเปลี่ยนหลอดไฟเดิมเป็น LED มีหลักการคำนวณอย่างไร?',
    summary: 'การคำนวณระยะเวลาคืนทุน (Payback Period) และความคุ้มค่าของการเปลี่ยนมาใช้ LED มีสูตรและตัวแปรหลักดังนี้:',
    steps: [
      '1. คำนวณพลังงานไฟฟ้าที่ประหยัดได้ต่อปี: kWh ที่ประหยัดได้ = [(วัตต์หลอดเดิมรวมบัลลาสต์ - วัตต์ LED ใหม่) × จำนวนโคม × ชั่วโมงเปิด/วัน × จำนวนวัน/ปี] ÷ 1,000',
      '2. คำนวณเงินประหยัดค่าไฟต่อปี: เงินประหยัดค่าไฟ = kWh ที่ประหยัดได้ต่อปี × อัตราค่าไฟฟ้าเฉลี่ย (บาท/หน่วย เช่น 4.50 - 4.70 บาท)',
      '3. รวมผลประหยัดค่าบำรุงรักษา (Maintenance Saving): ค่าเปลี่ยนหลอดเดิม/สตาร์ทเตอร์/บัลลาสต์ที่ลดลงได้ต่อปี (เนื่องจาก LED มีอายุ 30,000 - 50,000 ชม. นานกว่า 5-10 เท่า)',
      '4. คำนวณเงินลงทุนรวม (Total Investment): เงินลงทุน = (ราคาโคม/หลอด LED + ค่าแรงติดตั้งต่อจุด) × จำนวนโคม',
      '5. คำนวณระยะเวลาคืนทุน (Simple Payback Period): ระยะเวลาคืนทุน (ปี) = เงินลงทุนรวม ÷ ผลประหยัดรวมต่อปี (หรือคูณ 12 เพื่อหาจำนวนเดือน)'
    ],
    technicalTips: 'ในพื้นที่ปรับอากาศ (ห้องแอร์) หลอด LED ยังช่วยลดภาระความร้อนของเครื่องปรับอากาศได้อีกประมาณ 20-30% ของกำลังไฟแสงสว่างที่ลดลง ส่งผลให้แอร์กินไฟน้อยลงและคืนทุนเร็วขึ้นอีก',
    tags: ['จุดคุ้มทุน LED', 'Payback Period', 'ROI', 'ประหยัดพลังงาน', 'เปลี่ยนหลอด LED', 'คำนวณค่าไฟ'],
    authorName: 'ฝ่ายวิศวกรรม LUMENCRAFT',
    createdAt: '2026-08-19 15:30',
  },
  {
    id: 'faq-payback-2',
    category: 'general',
    categoryLabel: 'ความรู้เทคนิคไฟฟ้าทั่วไป',
    question: 'เปรียบเทียบการกินไฟและระยะเวลาคืนทุนระหว่างหลอดฟลูออเรสเซนต์ T8, โคม Highbay Metal Halide, หลอด Halogen กับหลอด LED?',
    summary: 'ตารางเปรียบเทียบการลดภาระกำลังไฟฟ้าและอัตราการคืนทุนโดยทั่วไป:',
    steps: [
      '1. หลอดฟลูออเรสเซนต์ T8 (36W + บัลลาสต์ 10W = 46W) เปลี่ยนเป็น LED Tube T8 18W: ประหยัดไฟ 60.8% คืนทุนเฉลี่ย 4-8 เดือน (เมื่อเปิด 12 ชม./วัน)',
      '2. โคมโรงงาน Highbay Metal Halide 250W (รวมบัลลาสต์ 290W) เปลี่ยนเป็น LED Highbay 100W: ประหยัดไฟ 65.5% คืนทุนเฉลี่ย 5-9 เดือน (เมื่อเปิด 24 ชม./วัน ในคลังสินค้า)',
      '3. โคมโรงงาน Highbay Metal Halide 400W (รวมบัลลาสต์ 450W) เปลี่ยนเป็น LED Highbay 150W: ประหยัดไฟ 66.7% คืนทุนเฉลี่ย 6-10 เดือน',
      '4. หลอดฮาโลเจน MR16 / GU10 50W เปลี่ยนเป็น LED Spotlight 7W: ประหยัดไฟ 86.0% คืนทุนเฉลี่ย 2-4 เดือน (เมื่อเปิด 24 ชม./วัน ในโรงแรม/ล็อบบี้)',
      '5. หลอด Compact Fluorescent Downlight CFL 26W (รวมบัลลาสต์ 32W) เปลี่ยนเป็น LED Downlight 12W: ประหยัดไฟ 62.5% คืนทุนเฉลี่ย 6-10 เดือน'
    ],
    technicalTips: 'หลอด Metal Halide และฟลูออเรสเซนต์มีค่าการสูญเสียในบัลลาสต์ขดลวด (Ballast Loss) อีก 15-20% ซึ่งมักถูกมองข้าม การเปลี่ยนเป็น LED แบบต่อตรงไฟ 220V ช่วยตัดการสูญเสียในบัลลาสต์ออก 100%',
    tags: ['เปรียบเทียบหลอดไฟ', 'Metal Halide vs LED', 'T8 vs LED Tube', 'ประหยัดไฟ 60%', 'คืนทุนกี่เดือน'],
    authorName: 'ช่างพัด (หัวหน้าวิศวกร)',
